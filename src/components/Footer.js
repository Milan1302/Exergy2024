...
export default function () {
  return (
    <div className='footer container-fluid'>
      <div className="row">
        <div className="col">
          <div className="row gradient-text" style={{ textAlign: "center" }}>
            <h2>CONNECT WITH US</h2>
          </div>
          <div className="row">
            <div className="col">
              <a href="https://m.facebook.com/100063877657618/">
            ...
            <div className="col">
              <a href="https://instagram.com/chemineersiitk?igshid=YmMyMTA2M2Y=">
            ...
            <div className="col">
              <a href="https://www.linkedin.com/in/chemineers">
        ...
        <div className="col">
          ...
          <div className="row">
            <div className="col">
              <div id="carouselExampleSlidesOnly" className="carousel slide" data-bs-ride="carousel" data-bs-interval="0" data-bs-pause="false">
